...
print("https://github.com/amirdecoder")
...
if __name__ == '__main__':
    def printLow(Str):
        for char in Str:
            ...
            sleep(.01)
    printLow(f'''{r}++++++++++++++++++++++++++++
{w} Telegram : T.me/amirdecoder
{g} +++++++++++++++++++++++++

{y}Info:
    {g}[+] {y}Coder: {r} @amirdecoder
    {g}[+] {y}instagram {p} amirdecoder
    {g}[+] {y}telegram {b} amirdecoder
    {g}[+] {y}Github: {w} https://github.com/amirdecoder
